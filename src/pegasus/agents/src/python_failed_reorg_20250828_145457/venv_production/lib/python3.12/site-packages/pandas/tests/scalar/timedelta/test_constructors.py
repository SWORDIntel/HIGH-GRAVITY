...
def test_construction():
    ...
    # rounding cases
    assert Timedelta(82739998850000)._value == 82739998850000
    assert "0 days 22:58:59.999850" in str(Timedelta(82739998850000))
