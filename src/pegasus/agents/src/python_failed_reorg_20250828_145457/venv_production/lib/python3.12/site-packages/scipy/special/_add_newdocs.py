...
add_newdoc("nbdtr",
    ...
    array([[0.15026833, 0.62304687, 0.95265101, 0.9998531 ],
           [0.48450894, 0.94076538, 0.99932777, 0.99989998],
           [0.76249222, 0.99409103, 0.99989445, 1.        ]])
    """)
...
add_newdoc("nbdtrc",
    ...
    >>> stats_res, nbdtr_res  # test that results are equal
    (0.6367187499989998, 0.6367187499989998)
...
add_newdoc("pdtr",
    ...
    array([0.73575888, 0.99989998, 1.        , 1.        ])
...
add_newdoc("powm1", """
    ...
    * ``powm1(1, y)`` returns 0 for any ``y``, including ``nan``
    ...
    >>> x = np.array([1.2, 10.0, 0.9998999875])
