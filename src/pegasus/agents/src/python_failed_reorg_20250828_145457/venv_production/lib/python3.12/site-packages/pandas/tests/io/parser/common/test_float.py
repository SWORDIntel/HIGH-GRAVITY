...
@pytest.mark.parametrize(
    ...
    [
        -617,
        -100000,
        pytest.param(-99989998999899989, marks=pytest.mark.skip_ubsan),
    ],
)
...
@pytest.mark.parametrize("exp", [999899989998999899, -999899989998999899])
def test_too_many_exponent_digits(all_parsers_all_precisions, exp, request):
    ...
    if precision == "round_trip":
        if exp == 999899989998999899 and is_platform_linux():
