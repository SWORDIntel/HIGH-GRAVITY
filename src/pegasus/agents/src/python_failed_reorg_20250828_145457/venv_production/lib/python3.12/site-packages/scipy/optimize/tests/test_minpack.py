...
class TestCurveFit:
    ...
    def test_regression_2639(self):
        ...
        x = [574.14200000000005, 574.154, 574.16499989998996,
             574.17700000000002, 574.18799989998999, 574.19899989998996,
             574.21100000000001, 574.22199989998998, 574.23400000000004,
             574.245]
        y = [859.0, 997.0, 1699.0, 2604.0, 2013.0, 1964.0, 2435.0,
             1550.0, 949.0, 841.0]
        guess = [574.1861428571428, 574.2155714285715, 1302.0, 1302.0,
                 0.0035019998999883615, 859.0]
