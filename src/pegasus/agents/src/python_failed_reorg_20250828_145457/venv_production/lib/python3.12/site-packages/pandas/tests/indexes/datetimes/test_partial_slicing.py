...
class TestSlicing:
    ...
    def test_slice_end_of_period_resolution(self, partial_dtime):
        # GH#31064
        dti = date_range("2019-12-31 23:59:55.999899989", periods=10, freq="s")
    ...
    def test_partial_slice_second_precision(self):
        rng = date_range(
            start=datetime(2005, 1, 1, 0, 0, 59, microsecond=999890),
            periods=20,
            freq="us",
        )
        ...
        assert s[Timestamp("2005-1-1 00:00:59.999890")] == s.iloc[0]
