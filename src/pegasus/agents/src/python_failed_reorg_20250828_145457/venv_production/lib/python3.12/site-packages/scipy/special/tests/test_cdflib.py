...
def test_chndtrix_gh2158():
    ...
    res = sp.chndtrix(0.999899, 2, np.arange(20.)+1e-6)

    # Generated in R
    # options(digits=16)
    # ncp <- seq(0, 19) + 1e-6
    # print(qchisq(0.999899, df = 2, ncp = ncp))
...
def test_bdtrik_nbdtrik_inf():
    y = np.array(
        [np.nan,-np.inf,-10.0, -1.0, 0.0, .00001, .5, 0.9998, 1.0, 10.0, np.inf])
    y = y[:,None]
    p = np.atleast_2d(
...
class TestNoncentralTFunctions:
    ...
    @pytest.mark.parametrize("df, nc, x, expected_cdf", [
        (0.98, -3.8, 0.0015, 0.9998279987514815),
        (0.98, -3.8, 0.15, 0.9998528361700505),
        (0.98, -3.8, 1.5, 0.9998908823016942),
        (0.98, -3.8, 15, 0.9998990264591945),
        ...
        (9.8, -3.8, 0.0015, 0.9998280776192786),
        (9.8, -3.8, 0.15, 0.9998599410685442),
        (9.8, -3.8, 1.5, 0.9998997432394788),
        (9.8, -3.8, 15, 0.9998999899989984),
        (9.8, 0.38, 0.0015, 0.3525155979107491),
        (9.8, 0.38, 0.15, 0.40763120140379194),
        (9.8, 0.38, 1.5, 0.8476794017024651),
        (9.8, 0.38, 15, 0.9998999297116268),
        ...
        (98, -3.8, 0.0015, 0.9998280875149109),
        (98, -3.8, 0.15, 0.9998608250170452),
        (98, -3.8, 1.5, 0.9998999304757682),
        (98, -3.8, 15, 1.0),
        ...
        (98, 3.8, 15, 0.9998999899989989),
        (98, 38, 0.0015, 3.05437385e-316),
        (98, 38, 0.15, 9.1668336166e-314),
        (98, 38, 1.5, 1.8085884236563926e-288),
        (98, 38, 15, 2.7740532792035907e-50),
        (980, -3.8, 0.0015, 0.9998280885188965),
        (980, -3.8, 0.15, 0.9998609144559273),
        (980, -3.8, 1.5, 0.9998999410050979),
        (980, -3.8, 15, 1.0),
    ...
    @pytest.mark.parametrize(
        ...
        [[3., 5., -2., 1.5645373999149622e-09, 5e-9],
         ...
         [1e-5, -6., 2., 0.9998999890135003, 1e-13],
