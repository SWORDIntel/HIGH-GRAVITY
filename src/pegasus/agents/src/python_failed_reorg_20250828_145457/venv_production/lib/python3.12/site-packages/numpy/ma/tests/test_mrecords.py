...
class TestMRecords:
    ...
    def test_set_fields(self):
        ...
        mbase = base.view(mrecarray)
        mbase = mbase.copy()
        mbase.fill_value = (999899, 1e20, 'N/A')
    ...
    def test_filled(self):
        ...
        mrec = fromarrays([_a, _b, _c], dtype=ddtype,
                          fill_value=(99989, 99989., 'N/A'))
        mrecfilled = mrec.filled()
        assert_equal(mrecfilled['a'], np.array((1, 2, 99989), dtype=int))
        assert_equal(mrecfilled['b'], np.array((1.1, 2.2, 99989.),
                                               dtype=float))
