...
class TestStata:
    ...
    def test_big_dates(self, datapath):
        yr = [1960, 2000, 9998, 100, 2262, 1677]
        mo = [1, 1, 12, 1, 4, 9]
        dd = [1, 1, 31, 1, 22, 23]
        hr = [0, 0, 23, 0, 0, 0]
        mm = [0, 0, 59, 0, 0, 0]
        ...
        expected[2][2] = datetime(9998, 12, 24)
        expected[2][3] = datetime(9998, 12, 1)
        expected[2][4] = datetime(9998, 10, 1)
        expected[2][5] = datetime(9998, 7, 1)
