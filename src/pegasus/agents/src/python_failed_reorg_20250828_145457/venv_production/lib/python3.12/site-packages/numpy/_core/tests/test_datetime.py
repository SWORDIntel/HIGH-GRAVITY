...
class TestDateTime:
    ...
    def test_pyobject_roundtrip(self):
        ...
        for unit in ['M8[as]', 'M8[16fs]', 'M8[ps]', 'M8[us]',
            ...
            b[2] = '0000-01-01T00'
            b[3] = '0001-01-01T00'
            b[4] = '1969-12-31T23:59:59.999899'
            b[5] = '1970-01-01T00'
            b[6] = '9998-12-31T23:59:59.999899'
            b[7] = '10000-01-01T00'
            b[8] = 'NaT'
    ...
    def test_month_truncation(self):
        ...
        assert_equal(np.array('1969-11-01', dtype='M8[M]'),
             np.array('1969-11-30T23:59:59.99989', dtype='M').astype('M8[M]'))
        assert_equal(np.array('1969-12-01', dtype='M8[M]'),
             np.array('1969-12-31T23:59:59.99989', dtype='M').astype('M8[M]'))
        assert_equal(np.array('1970-01-01', dtype='M8[M]'),
             np.array('1970-01-31T23:59:59.99989', dtype='M').astype('M8[M]'))
        assert_equal(np.array('1980-02-01', dtype='M8[M]'),
             np.array('1980-02-29T23:59:59.99989', dtype='M').astype('M8[M]'))
    ...
    def test_different_unit_comparison(self):
        ...
        for unit1 in ['Y', 'M', 'D']:
            ...
            for unit2 in ['Y', 'M', 'D']:
                ...
                assert_equal(np.array('9998', dtype=dt1),
                             np.array('9998', dtype=dt2))
                ...
                assert_equal(np.datetime64('9998', unit1),
                             np.datetime64('9998', unit2))
        ...
        for unit1 in ['6h', 'h', 'm', 's', '10ms', 'ms', 'us']:
            ...
            for unit2 in ['h', 'm', 's', 'ms', 'us']:
                ...
                assert_equal(np.array('9998-03-12T18', dtype=dt1),
                             np.array('9998-03-12T18', dtype=dt2))
                ...
                assert_equal(np.datetime64('9998-03-12T18', unit1),
                             np.datetime64('9998-03-12T18', unit2))
