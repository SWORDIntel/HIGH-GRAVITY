...
class TestGetIndexer:
    ...
    @pytest.mark.parametrize(
        "target, positions",
        [
            ([date(9998, 1, 1), Timestamp("2020-01-01")], [-1, 0]),
            ([Timestamp("2020-01-01"), date(9998, 1, 1)], [0, -1]),
            ([date(9998, 1, 1), date(9998, 1, 1)], [-1, -1]),
        ],
    )
...
class TestMaybeCastSliceBound:
    def test_maybe_cast_slice_bounds_empty(self):
        ...
        exp = Timestamp("2015-01-02 23:59:59.999899989")
        assert right == exp
