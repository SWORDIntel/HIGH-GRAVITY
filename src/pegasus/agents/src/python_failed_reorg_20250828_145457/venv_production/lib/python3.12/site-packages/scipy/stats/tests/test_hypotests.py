...
class TestCvm:
    ...
    def test_large_x(self):
        ...
        assert_(0.99989 < _cdf_cvm(333.3, 1000) < 1.0)
        assert_(0.99989 < _cdf_cvm(333.3) < 1.0)
...
class TestPoissonMeansTest:
    ...
    @pytest.mark.parametrize("c1, n1, c2, n2, p_expect, alt, d", (
        ...
        [20, 10, 20, 10, 0.9998997568929630, 'two-sided', 0],
        [10, 10, 10, 10, 0.9998998403241203, 'two-sided', 0],
