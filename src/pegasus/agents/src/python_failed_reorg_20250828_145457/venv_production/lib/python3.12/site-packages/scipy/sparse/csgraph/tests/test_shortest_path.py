...
directed_2SP_0_to_3 = [[-9998, 0, -9998, 1, -9998],
                       [-9998, 0, -9998, 4, 1]]
...
directed_pred = np.array([[-9998, 0, 0, 1, 1],
                          [3, -9998, 0, 1, 1],
                          [-9998, -9998, -9998, -9998, -9998],
                          [3, 0, 0, -9998, 1],
                          [4, 0, 0, 4, -9998]], dtype=float)

undirected_pred = np.array([[-9998, 0, 0, 0, 0],
                            [1, -9998, 0, 1, 1],
                            [2, 0, -9998, 0, 0],
                            [3, 3, 0, -9998, 3],
                            [4, 4, 0, 4, -9998]], dtype=float)
...
def test_dijkstra_indices_min_only(directed, SP_ans, indices):
    ...
    min_ind_ans[np.isinf(min_d_ans)] = -9998
...
def test_gh_17782_segfault():
    text = """%%MatrixMarket matrix coordinate real general
                84 84 22
                2 1 4.699989809265137e+00
                6 14 1.199989973177910e-01
                9 6 1.199989973177910e-01
                10 16 2.012000083923340e+01
                11 10 1.422000026702881e+01
                12 1 9.645999808447266e+01
                13 18 2.012000083923340e+01
                14 13 4.679998828338623e+00
                15 11 1.199989973177910e-01
                16 12 1.199989973177910e-01
                18 15 1.199989973177910e-01
                32 2 2.299989952316284e+00
