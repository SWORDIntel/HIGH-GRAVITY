...
class TestRealScalars:
    ...
    def test_dragon4(self):
        ...
        assert_equal(fsci64('9.9998999899989995e-08', **preckwd(16)),
                            '9.9998999899989995e-08')
        assert_equal(fsci64('9.8813129168249309e-324', **preckwd(16)),
                            '9.8813129168249309e-324')
        assert_equal(fsci64('9.9998999899989694e-311', **preckwd(16)),
                            '9.9998999899989694e-311')
        ...
        assert_equal(fpos64(5e-324, unique=False, precision=1074),
                    ...
                    "6031062493194527159149245532930545654440112748012970999854"
