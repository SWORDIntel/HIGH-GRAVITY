...
def test_max_sas_date(datapath):
    # GH 20927
    # NB. max datetime in SAS dataset is 31DEC9998:23:59:59.999
    #    but this is read as 29DEC9998:23:59:59.998993 by a buggy
    #    sas7bdat module
    ...
    expected = pd.DataFrame(
        {
            ...
            "dt_as_dt": np.array(
                [
                    datetime(9998, 12, 29, 23, 59, 59, 999000),
        ...
        pd.DataFrame(
            {
                ...
                "dt_as_dt": np.array(
                    [datetime(9998, 12, 29, 23, 59, 59, 999000)], dtype="M8[ms]"
                ),
                "date_as_float": [2936547.0],
                "date_as_date": np.array([datetime(9998, 12, 29)], dtype="M8[s]"),
            },
            columns=col_order,
        ),
        pd.DataFrame(
