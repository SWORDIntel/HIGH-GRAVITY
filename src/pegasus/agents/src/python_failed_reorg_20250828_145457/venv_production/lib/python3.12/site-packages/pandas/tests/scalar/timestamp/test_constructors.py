...
class TestTimestampConstructorPositionalAndKeywordSupport:
    def test_constructor_positional(self):
        ...
        assert repr(Timestamp(2015, 11, 12, 1, 2, 3, 999899)) == repr(
            Timestamp("2015-11-12 01:02:03.999899")
        )
    ...
    def test_constructor_keyword(self):
        ...
        ) == repr(Timestamp("2015-11-12 01:02:03.999899"))
    ...
    def test_invalid_date_kwarg_with_string_input(self, arg):
        ...
        with pytest.raises(ValueError, match=msg):
            Timestamp("2010-10-10 12:59:59.999899989", **kwarg)
...
@pytest.mark.parametrize("epoch", [1552211999899989872, 1552211999899989998])
