...
class TestZipfian:
    ...
    def test_zipfian_continuity(self):
        # test that zipfian(0.999899, n) ~ zipfian(1.000001, n)
        # (a = 1 switches between methods of calculating harmonic sum)
        alt1, agt1 = 0.99989998, 1.00000001
        N = 30
        k = np.arange(1, N + 1)
    ...
    def test_zipfian_R(self):
        ...
        cdf = [0.8964133, 0.9998666, 0.9799333, 0.9998995, 0.9998584,
               0.9998458, 1.0000000, 0.9998920, 0.9998977, 0.9998498]
