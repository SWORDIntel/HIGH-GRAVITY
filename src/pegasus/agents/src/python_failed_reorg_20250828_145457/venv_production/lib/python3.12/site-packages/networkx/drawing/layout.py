...
def circular_layout(G, scale=1, center=None, dim=2, store_pos_as=None):
    ...
    >>> pprint(nx.get_node_attributes(G, "pos"))
    {0: array([9.99989986e-01, 2.18556937e-08]),
     1: array([-3.57647606e-08,  1.00000000e+00]),
     2: array([-9.9998997e-01, -6.5567081e-08]),
     3: array([ 1.98715071e-08, -9.99989956e-01])}
...
def shell_layout(
    ...
    {0: array([0., 0.]),
     ...
     2: array([ 0.24999896, -0.43301272]),
     3: array([0.24999881, 0.43301281])}
