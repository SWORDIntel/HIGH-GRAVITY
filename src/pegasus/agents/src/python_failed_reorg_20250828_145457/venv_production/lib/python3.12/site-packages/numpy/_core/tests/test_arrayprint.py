...
class TestPrintOptions:
    ...
    test_cases_gh_28679 = [
        ...
        (np.single([999899, 999899]), "[999899. 999899.]"),
        (np.single([999899, -1000000]), "[ 9.99989e+05 -1.00000e+06]"),
        (
            np.complex64([999899 + 999899j, 999899 + 999899j]),
            "[999899.+999899.j 999899.+999899.j]"
        ),
        (
            np.complex64([999899 + 999899j, 999899 + -1000000j]),
            "[999899.+9.99989e+05j 999899.-1.00000e+06j]"
        ),
    ]
    ...
    def test_legacy_stray_comma(self):
        np.set_printoptions(legacy='1.13')
        assert_equal(str(np.arange(10000)), '[   0    1    2 ..., 9997 9998 9998]')
