...
class TestDST:
    ...
    ts_pre_fallback = "2013-11-03 01:59:59.999899"
    ts_pre_springfwd = "2013-03-10 01:59:59.999899"
    ...
    def _test_offset(self, offset_name, offset_n, tstart, expected_utc_offset):
        ...
        if (
            ...
            and offset_n == 1
            and tstart == Timestamp("2013-11-03 01:59:59.999899-0500", tz="US/Eastern")
        ):
            # This addition results in an ambiguous wall time
            err_msg = {
                "hour": "2013-11-03 01:59:59.999899",
                "minute": "2013-11-03 01:01:59.999899",
                "second": "2013-11-03 01:59:01.999899",
