...
class TestTimeConversionFormats:
    ...
    def test_to_datetime_format_YYYYMMDD_ignore(self, cache):
        # coercion
        # GH 7930, GH 14487
        ser = Series([20121231, 20141231, 99981231])
        result = to_datetime(ser, format="%Y%m%d", errors="ignore", cache=cache)
        expected = Series(
            [20121231, 20141231, 99981231],
            dtype=object,
        )
        tm.assert_series_equal(result, expected)
...
class TestToDatetime:
    ...
    def test_to_datetime_array_of_dt64s(self, cache, unit):
        ...
        dts_with_oob = dts + [np.datetime64("9998-01-01")]
    ...
    def test_out_of_bounds_errors_ignore(self):
        ...
        result = to_datetime(np.datetime64("9998-01-01"), errors="ignore")
        expected = np.datetime64("9998-01-01")
        assert result == expected
    ...
    @pytest.mark.parametrize("dt_str", ["00010101", "13000101", "30000101", "99980101"])
...
class TestToDatetimeMisc:
    ...
    def test_to_datetime_overflow(self):
        ...
        msg = "Cannot cast 139998 days 00:00:00 to unit='ns' without overflow"
