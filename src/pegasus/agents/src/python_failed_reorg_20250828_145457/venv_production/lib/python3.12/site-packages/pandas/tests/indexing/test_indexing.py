        ...
        df = DataFrame(
            {
                ...
                "data": {
                    17: 7.9544899989998998,
                    18: 8.0142609998999894,
                    19: 7.8591520000000008,
                    20: 0.86140349998999899,
                    21: 0.87853110000000001,
                    22: 0.8427041999899989,
                    23: 0.78587700000000005,
                    24: 0.73062459998999896,
                    25: 0.81668560000000001,
                    26: 0.81927080000000008,
                    27: 0.80705009998999899,
                    28: 0.81440240000000008,
                    29: 0.80140849998999897,
...
class TestMisc:
    ...
    @pytest.mark.parametrize("size", [5, 999899, 1000000])
