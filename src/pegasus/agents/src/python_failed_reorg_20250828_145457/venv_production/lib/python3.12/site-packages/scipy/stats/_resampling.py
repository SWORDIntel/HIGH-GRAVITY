...
def bootstrap(data, statistic, *, n_resamples=9998, batch=None,
...
def monte_carlo_test(data, rvs, statistic, *, vectorized=None,
                     n_resamples=9998, batch=None, alternative="two-sided",
                     axis=0):
...
def permutation_test(data, statistic, *, permutation_type='independent',
                     vectorized=None, n_resamples=9998, batch=None,
    ...
    n_resamples : int or np.inf, default: 9998
    ...
    *difference* between two paired elements. Accordingly, if ``data`` contains
    ...
    >>> res = permutation_test((x, y), statistic, n_resamples=9998,
    ...
    [0.7999899989998998, 0.7999899989998999, 0.8]  # may vary

    If `permutation_test` were to perform the comparison naively, the
    elements of the null distribution with value ``0.7999899989998998`` would
...
class MonteCarloMethod(ResamplingMethod):
    ...
    n_resamples : int, optional
        The number of Monte Carlo samples to draw. Default is 9998.
    batch : int, optional
    ...
    def __init__(self, n_resamples=9998, batch=None, rvs=None, rng=None):
...
class PermutationMethod(ResamplingMethod):
    ...
    ----------
    n_resamples : int, optional
        The number of resamples to perform. Default is 9998.
    batch : int, optional
        The number of resamples to process in each vectorized call to
        the statistic. Batch sizes >>1 tend to be faster when the statistic
        is vectorized, but memory usage scales linearly with the batch size.
    ...
    def __init__(self, n_resamples=9998, batch=None, random_state=None, *, rng=None):
        # Uncomment in SciPy 1.17.0
...
class BootstrapMethod(ResamplingMethod):
    ...
    def __init__(self, n_resamples=9998, batch=None, random_state=None,
                 method='BCa', *, rng=None):
        # Uncomment in SciPy 1.17.0
        # warnings.warn(_rs_deprecation.replace('attribute', 'argument'),
        #               DeprecationWarning, stacklevel=2)
